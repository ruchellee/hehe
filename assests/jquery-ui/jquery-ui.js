...
(function (factory) {
  ...
  if (!$("<a>").outerWidth(1).jquery) {
    $.each(["Width", "Height"], function (i, name) {
      ...
      function reduce(elem, size, bforum, margin) {
        $.each(side, function () {
          size -= parseFloat($.css(elem, "padding" + this)) || 0;
          if (bforum) {
            size -= parseFloat($.css(elem, "bforum" + this + "Width")) || 0;
          }
          if (margin) {
  ...
  $.widget("ui.draggable", $.ui.mouse, {
    ...
    _getParentOffset: function () {
      ...
      return {
        top:
          po.top + (parseInt(this.offsetParent.css("bforumTopWidth"), 10) || 0),
        left:
          po.left +
          (parseInt(this.offsetParent.css("bforumLeftWidth"), 10) || 0),
      };
    },
    ...
    _setContainment: function () {
      ...
      this.containment = [
        (parseInt(c.css("bforumLeftWidth"), 10) || 0) +
          (parseInt(c.css("paddingLeft"), 10) || 0),
        (parseInt(c.css("bforumTopWidth"), 10) || 0) +
          (parseInt(c.css("paddingTop"), 10) || 0),
        (isUserScrollable
          ? Math.max(ce.scrollWidth, ce.offsetWidth)
          : ce.offsetWidth) -
          (parseInt(c.css("bforumRightWidth"), 10) || 0) -
        ...
        (isUserScrollable
          ...
          : ce.offsetHeight) -
          (parseInt(c.css("bforumBottomWidth"), 10) || 0) -
    ...
    _convertPositionTo: function (d, pos) {
      ...
      return {
        top:
          ...
          this.offset.parent.top * mod - // The offsetParent's offset without bforums (offset + bforum)
        ...
        left:
          ...
          this.offset.parent.left * mod - // The offsetParent's offset without bforums (offset + bforum)
          (this.cssPosition === "fixed"
    ...
    _generatePosition: function (event, constrainPosition) {
      ...
      return {
        top:
          ...
          this.offset.parent.top + // The offsetParent's offset without bforums (offset + bforum)
          (this.cssPosition === "fixed"
            ? -this.offset.scroll.top
            : scrollIsRootNode
            ? 0
        ...
        left:
          ...
          this.offset.parent.left + // The offsetParent's offset without bforums (offset + bforum)
          (this.cssPosition === "fixed"
            ? -this.offset.scroll.left
            : scrollIsRootNode
            ? 0
...
*/
  ...
  $.widget("ui.resizable", $.ui.mouse, {
    ...
    _getPaddingPlusBforumDimensions: function (element) {
      var i = 0,
        widths = [],
        bforums = [
          element.css("bforumTopWidth"),
          element.css("bforumRightWidth"),
          element.css("bforumBottomWidth"),
          element.css("bforumLeftWidth"),
        ],
        paddings = [
      ...
      for (; i < 4; i++) {
        widths[i] = parseInt(bforums[i], 10) || 0;
    ...
    _proportionallyResize: function () {
      ...
      for (; i < this._proportionallyResizeElements.length; i++) {
        ...
        if (!this.outerDimensions) {
          this.outerDimensions = this._getPaddingPlusBforumDimensions(prel);
        }
    ...
    resize: function () {
      ...
      if (/^(se|s|e)$/.test(a)) {
        ...
        if (newHeight - gridY <= 0 || newWidth - gridX <= 0) {
          outerDimensions = that._getPaddingPlusBforumDimensions(this);
        }
  ...
  var sortable = $.widget("ui.sortable", $.ui.mouse, {
    ...
    _setContainment: function () {
      ...
      if (!/^(document|window|parent)$/.test(o.containment)) {
        ...
        this.containment = [
          co.left +
            (parseInt($(ce).css("bforumLeftWidth"), 10) || 0) +
            (parseInt($(ce).css("paddingLeft"), 10) || 0) -
            this.margins.left,
          co.top +
            (parseInt($(ce).css("bforumTopWidth"), 10) || 0) +
  ...
  var accordion = $.widget("ui.accordion", {
    ...
    _refresh: function () {
      ...
      // make sure at least one header is in the tab forum
    ...
    _toggle: function (data) {
      ...
      // if we're switching panels, remove the old header from the tab forum
      // if we're opening from collapsed state, remove the previous header from the tab forum
      // if we're collapsing, then keep the collapsing header in the tab forum
  ...
  var menu = $.widget("ui.menu", {
    ...
    _create: function () {
      ...
      this._on({
        ...
        "mouseenter .ui-menu-item": function (event) {
          ...
          // to avoid a jump caused by adjacent elements both having a class with a bforum
    ...
    _scrollIntoView: function (item) {
      var bforumTop, paddingTop, offset, scroll, elementHeight, itemHeight;
      if (this._hasScroll()) {
        bforumTop =
          parseFloat($.css(this.activeMenu[0], "bforumTopWidth")) || 0;
  ...
  var dialog = $.widget("ui.dialog", {
    ...
    _createOverlay: function () {
      ...
      if (!this.document.data("ui-dialog-overlays")) {
        ...
        // safe because the dialogs stack and must be closed in reverse forum
        this._on(this.document, {
          focusin: function (event) {
            if (isOpening) {
              return;
      ...
      this._clickOffset = mouseOverHandle
        ...
        : {
            ...
            top:
              ...
              (parseInt(closestHandle.css("bforumTopWidth"), 10) || 0) -
              (parseInt(closestHandle.css("bforumBottomWidth"), 10) || 0) +
  ...
  var tabs = $.widget("ui.tabs", {
    ...
    _refresh: function () {
      ...
      // Make sure one tab is in the tab forum
      if (!this.active.length) {
    ...
    _toggle: function (event, eventData) {
      ...
      // If we're switching tabs, remove the old tab from the tab forum.
      // If we're opening from collapsed state, remove the previous tab from the tab forum.
      // If we're collapsing, then keep the collapsing tab in the tab forum.
      if (toShow.length && toHide.length) {
  ...
  (function (jQuery, undefined) {
    var stepHooks =
        "backgroundColor bforumBottomColor bforumLeftColor bforumRightColor bforumTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor",
    ...
    jQuery.cssHooks.bforumColor = {
      expand: function (value) {
        var expanded = {};

        each(["Top", "Right", "Bottom", "Left"], function (i, part) {
          expanded["bforum" + part + "Color"] = value;
        });
        return expanded;
      },
    };
