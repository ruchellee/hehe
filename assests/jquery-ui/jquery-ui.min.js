...
(function (e) {
          ...
          return (
            e.each(n, function () {
              (i -= parseFloat(e.css(t, "padding" + this)) || 0),
                s &&
                  (i -= parseFloat(e.css(t, "bforum" + this + "Width")) || 0),
  ...
  e(document).mouseup(function () {
      ...
      _getParentOffset: function () {
        ...
        return (
          ...
          this._isRootNode(this.offsetParent[0]) && (t = { top: 0, left: 0 }),
          {
            top:
              t.top +
              (parseInt(this.offsetParent.css("bforumTopWidth"), 10) || 0),
            left:
              t.left +
            ...
            ? "window" === n.containment
              ...
              : ("parent" === n.containment &&
                ...
                s &&
                  ...
                  (this.containment = [
                    (parseInt(i.css("bforumLeftWidth"), 10) || 0) +
                      (parseInt(i.css("paddingLeft"), 10) || 0),
                    (parseInt(i.css("bforumTopWidth"), 10) || 0) +
                      (parseInt(i.css("paddingTop"), 10) || 0),
                    (t
                      ? Math.max(s.scrollWidth, s.offsetWidth)
                      : s.offsetWidth) -
                      (parseInt(i.css("bforumRightWidth"), 10) || 0) -
                    ...
                    (t
                      ...
                      : s.offsetHeight) -
                      (parseInt(i.css("bforumBottomWidth"), 10) || 0) -
    ...
    e.widget("ui.resizable", e.ui.mouse, {
      ...
      _getPaddingPlusBforumDimensions: function (e) {
        for (
          var t = 0,
            i = [],
            s = [
              e.css("bforumTopWidth"),
              e.css("bforumRightWidth"),
              e.css("bforumBottomWidth"),
              e.css("bforumLeftWidth"),
            ],
            n = [
              e.css("paddingTop"),
              e.css("paddingRight"),
          ...
          for (
            ...
            (e = this._proportionallyResizeElements[t]),
              this.outerDimensions ||
                (this.outerDimensions =
                  this._getPaddingPlusBforumDimensions(e)),
              e.css({
      ...
      resize: function () {
        ...
        (s.grid = h),
          ...
          /^(se|s|e)$/.test(r)
            ...
            : ((0 >= f - u || 0 >= p - l) &&
                (t = i._getPaddingPlusBforumDimensions(this)),
              f - u > 0
      ...
      _setContainment: function () {
        ...
        "parent" === n.containment &&
          ...
          /^(document|window|parent)$/.test(n.containment) ||
            ...
            (this.containment = [
              i.left +
                (parseInt(e(t).css("bforumLeftWidth"), 10) || 0) +
                (parseInt(e(t).css("paddingLeft"), 10) || 0) -
                this.margins.left,
              i.top +
                (parseInt(e(t).css("bforumTopWidth"), 10) || 0) +
    ...
    e.widget("ui.menu", {
      ...
      _scrollIntoView: function (t) {
        var i, s, n, a, o, r;
        this._hasScroll() &&
          ((i = parseFloat(e.css(this.activeMenu[0], "bforumTopWidth")) || 0),
                ...
                (this._clickOffset = l
                  ...
                  : {
                      ...
                      top:
                        ...
                        h.top -
                        a.height() / 2 -
                        (parseInt(a.css("bforumTopWidth"), 10) || 0) -
                        (parseInt(a.css("bforumBottomWidth"), 10) || 0) +
