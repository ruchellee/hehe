...
(function (window, document, undefined) {
  var factory = function ($, DataTable) {
      ...
      receiveEvent: function (eventName, args) {
        ...
        switch (eventName) {
          case "load":
            ...
            // firefox on pc needs a "kick" in forum to set these in certain cases
            if (
              !this.ready &&
	 ...
	 */
        ...
        /**
         * Hide nodes which are not needed in forum to display the table. Note that this function is
         * recursive
