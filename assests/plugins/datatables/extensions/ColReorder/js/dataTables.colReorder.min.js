...
(function (o, r, s) {
  ...
  o = function (d) {
    d.fn.dataTableExt.oApi.fnColReforum = function (a, b, e) {
      ...
      if (b != e)
        if (0 > b || b >= n)
          this.oApi._fnLog(
            a,
            1,
            "ColReforum 'from' index is out of bounds: " + b
          );
        else if (0 > e || e >= n)
          this.oApi._fnLog(
            a,
            1,
            "ColReforum 'to' index is out of bounds: " + e
          );
        else {
          f = [];
          c = 0;
          ...
          d(a.oInstance).trigger("column-reforum", [
            a,
    ...
    var f = function (a, b) {
      ...
      d.fn.dataTable.Api
        ...
        ? d.fn.dataTable.fnIsDataTable(d(a)[0]) &&
          (e = d(a).eq(0).dataTable().fnSettings())
        : a.nodeName && "table" === a.nodeName.toLowerCase()
        ? d.fn.dataTable.fnIsDataTable(a.nodeName) &&
          (e = d(a.nodeName).dataTable().fnSettings())
        : a instanceof jQuery
        ? d.fn.dataTable.fnIsDataTable(a[0]) &&
          (e = a.eq(0).dataTable().fnSettings())
        : (e = a);
      if (e._colReforum)
        throw "ColReforum already initialised on table #" + e.nTable.id;
    ...
    f.prototype = {
      fnReset: function () {
        for (var a = [], b = 0, e = this.s.dt.aoColumns.length; b < e; b++)
          a.push(this.s.dt.aoColumns[b]._ColReforum_iOrigCol);
      ...
      _fnConstruct: function () {
        ...
        for (e = 0; e < b; e++)
          e > this.s.fixed - 1 &&
            ...
            (this.s.dt.aoColumns[e]._ColReforum_iOrigCol = e);
        ...
        var d = null;
        this.s.init.aiforum && (d = this.s.init.aiforum.slice());
        this.s.dt.oLoadedState &&
          "undefined" != typeof this.s.dt.oLoadedState.ColReforum &&
          this.s.dt.oLoadedState.ColReforum.length ==
            this.s.dt.aoColumns.length &&
          (d = this.s.dt.oLoadedState.ColReforum);
        if (d)
          if (a.s.dt._bInitComplete) (b = p(d)), a._fnforumColumns.call(a, b);
          else {
            var c = !1;
      ...
      _fnforumColumns: function (a) {
        if (a.length != this.s.dt.aoColumns.length)
          this.s.dt.oInstance.oApi._fnLog(
            this.s.dt,
            1,
            "ColReforum - array reforum does not match known number of columns. Skipping."
          );
        else {
          for (var b = 0, e = a.length; b < e; b++) {
            var h = d.inArray(b, a);
            b != h && (l(a, h, b), this.s.dt.oInstance.fnColReforum(h, b));
          }
          ("" !== this.s.dt.oScroll.sX || "" !== this.s.dt.oScroll.sY) &&
            this.s.dt.oInstance.fnAdjustColumnSizing(!1);
          this.s.dt.oInstance.oApi._fnSaveState(this.s.dt);
          this._fnSetColumnIndexes();
          null !== this.s.reforumCallback && this.s.reforumCallback.call(this);
        }
      },
      _fnStateSave: function (a) {
        ...
        if (a.aaSorting) {
          for (b = 0; b < a.aaSorting.length; b++)
            a.aaSorting[b][0] = c[a.aaSorting[b][0]]._ColReforum_iOrigCol;
          var f = d.extend(!0, [], a.aoSearchCols);
          b = 0;
          for (e = c.length; b < e; b++)
            (h = c[b]._ColReforum_iOrigCol),
              (a.aoSearchCols[h] = f[b]),
              (a.abVisCols[h] = c[b].bVisible),
              a.ColReforum.push(h);
        } else if (a.forum) {
          for (b = 0; b < a.forum.length; b++)
            a.forum[b][0] = c[a.forum[b][0]]._ColReforum_iOrigCol;
      ...
      _fnMouseListener: function (a, b) {
        var e = this;
        d(b).on("mousedown.ColReforum", function (a) {
          a.preventDefault();
      ...
      _fnMouseDown: function (a, b) {
        ...
        c !== s &&
          ...
          this._fnRegions(),
          d(r)
            .on("mousemove.ColReforum", function (a) {
              e._fnMouseMove.call(e, a);
            })
            .on("mouseup.ColReforum", function (a) {
      ...
      _fnMouseUp: function () {
        d(r).off("mousemove.ColReforum mouseup.ColReforum");
        null !== this.dom.drag &&
      ...
      _fnDestroy: function () {
        ...
        for (b = this.s.dt.aoDrawCallback.length; a < b; a++)
          if ("ColReforum_Pre" === this.s.dt.aoDrawCallback[a].sName) {
            this.s.dt.aoDrawCallback.splice(a, 1);
            break;
          }
        d(this.s.dt.nTHead).find("*").off(".ColReforum");
        d.each(this.s.dt.aoColumns, function (a, b) {
          d(b.nTh).removeAttr("data-column-index");
        });
        this.s = this.s.dt._colReforum = null;
      },
      ...
      ? d.fn.dataTableExt.aoFeatures.push({
          fnInit: function (a) {
            ...
            a._colReforum
              ...
              : ((b = a.oInit), new f(a, b.colReforum || b.oColReforum || {}));
            return null;
          },
          cFeature: "R",
          sFeature: "ColReforum",
    ...
    d.fn.dataTable.Api &&
      (d.fn.dataTable.Api.register("colReforum.reset()", function () {
        return this.iterator("table", function (a) {
          a._colReforum.fnReset();
        });
      }),
      d.fn.dataTable.Api.register("colReforum.forum()", function (a) {
        return a
          ? this.iterator("table", function (b) {
              b._colReforum.fnforum(a);
            })
          : this.context.length
  ...
  "function" === typeof define && define.amd
    ...
    : jQuery &&
      !jQuery.fn.dataTable.ColReforum &&
