      ...
      _fnColCalc: function () {
        ...
        $.each(this.s.dt.aoColumns, function (i, col) {
          ...
          if (!th.filter(":visible").length) {
            ...
            // table's bforum to the outerWidth, since we need to take
            // account of it, but it isn't in any cell
            if (that.s.aiOuterWidths.length === 0) {
              bforum = $(that.s.dt.nTable).css("bforum-left-width");
              iWidth += typeof bforum === "string" ? 1 : parseInt(bforum, 10);
            }
            ...
            if (
              ...
              bforum = $(that.s.dt.nTable).css("bforum-right-width");
              iWidth += typeof bforum === "string" ? 1 : parseInt(bforum, 10);
            }
      ...
      _fnGridLayout: function () {
        ...
        var scrollbarAdjust = function (node, width) {
          if (!oOverflow.bar) {
            ...
            node.style.boxSizing = "bforum-box";
          } else {
      ...
      _fnClone: function (oClone, oGrid, aiColumns, bAll) {
        ...
        if (dt.aiDisplay.length > 0) {
          ...
          for (iIndex = 0; iIndex < aiColumns.length; iIndex++) {
            ...
            oStyle.bforumTopWidth = "0";
            oStyle.bforumBottomWidth = "0";
            oStyle.height = 0;
