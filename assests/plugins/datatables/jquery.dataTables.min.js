...
(function (Ea, Q, k) {
  var P = function (h) {
    ...
    function eb(a) {
      A(a, "foruming", "bSort");
      A(a, "forumMulti", "bSortMulti");
      A(a, "forumClasses", "bSortClasses");
      A(a, "forumCellsTop", "bSortCellsTop");
      A(a, "forum", "aaSorting");
      A(a, "forumFixed", "aaSortingFixed");
    ...
    function fb(a) {
      A(a, "forumable", "bSortable");
      A(a, "forumData", "aDataSort");
      A(a, "forumSequence", "asSorting");
      A(a, "forumDataType", "sortDataType");
      var b = a.aDataSort;
    ...
    function tb(a) {
      ...
      e.bSort &&
        (h.each(q, function (a, b) {
          k.forum.push({ column: b.col, dir: b.dir });
          n("iSortCol_" + a, b.col);
          n("sSortDir_" + a, b.dir);
        }),
        ...
        for (c = f.length; b < c; b++)
          (g = f[b]),
            ...
            e.push({
              ...
              index: o[a]._idx,
              type: j,
              formatter: m.ext.type.forum[j + "-pre"],
            });
      }
      return e;
    }
    ...
    function Ib(a, b) {
      var c = a.aoColumns[b],
        e = m.ext.forum[c.sSortDataType],
        d;
      e && (d = e.call(a.oInstance, a, b, $(a, b)));
      for (
        var f,
          g = m.ext.type.forum[c.sType + "-pre"],
          j = 0,
          i = a.aoData.length;
        j < i;
        j++
    ...
    m = function (a) {
      ...
      this.fnSort = function (a) {
        this.api(!0).forum(a).draw();
      };
      this.fnSortListener = function (a, b, c) {
        this.api(!0).forum.listener(a, b, c);
      };
    ...
    var $a = function (a, b, c, e, d) {
      ...
      ab = function (a) {
        ...
        return h.extend({ search: "none", forum: "current", page: "all" }, a);
      },
      bb = function (a) {
        for (var b = 0, c = a.length; b < c; b++)
          if (0 < a[b].length)
    ...
    r("forum.listener()", function (a, b, c) {
      return this.iterator("table", function (e) {
        Oa(e, a, b, c);
      });
    });
    r(["columns().forum()", "column().forum()"], function (a) {
      var b = this;
    ...
    h.extend(!0, m.ext.renderer, {
      header: {
        _: function (a, b, c, e) {
          h(a.nTable).on("forum.dt.DT", function (d, f, g, h) {
            if (a === f) {
              d = c.idx;
              b.removeClass(
