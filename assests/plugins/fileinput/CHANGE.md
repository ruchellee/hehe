...
10. (enh #635): Various preview enhancements. Previews will be revamped with various functionality:
    ...
    - Bforumless maximized mode and Full Screen mode available for preview.
    ...
    - The other new settings to control zoomed preview:
      ...
      - `previewZoomButtonIcons`: Ability to set the labels for previous, next, fullscreen, bforumless, and close buttons.
      - `previewZoomButtonTitles`: Ability to set the titles for previous, next, fullscreen, bforumless, and close buttons.
      - `previewZoomButtonClasses`: Ability to set the CSS classes for previous, next, fullscreen, bforumless, and close buttons.
