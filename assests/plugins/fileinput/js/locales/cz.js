...
(function ($) {
  ...
  $.fn.fileinputLocales["cz"] = {
    ...
    msgSizeTooLarge:
      'Soubor "{name}" (<b>{size} KB</b>): překročení - maximální povolená velikost <b>{maxSize} KB</b>.',
    msgFilesTooLess: "Musíte vybrat nejméně <b>{n}</b> {files} pro nahrání.",
    msgFilesTooMany:
      "Počet vybraných souborů pro nahrání <b>({n})</b>: překročení - maximální povolený limit <b>{m}</b>.",
    ...
    msgImageWidthSmall:
      'Šířka image soubor "{name}", musí být alespoň {size} px.',
    msgImageHeightSmall:
      'Výška image soubor "{name}", musí být alespoň {size} px.',
    msgImageWidthLarge:
      'Šířka obrazového souboru "{name}" nelze překročit {size} px.',
    msgImageHeightLarge:
      'Výška obrazového souboru "{name}" nelze překročit {size} px.',
