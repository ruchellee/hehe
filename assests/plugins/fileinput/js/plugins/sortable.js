...
(function (factory) {
        ...
        if (
          ...
          if (el) {
            autoScroll.pid = setInterval(function () {
              if (el === win) {
                win.scrollTo(
                  win.pageXOffset + vx * speed,
                  win.pageYOffset + vy * speed
                );
              } else {
  ...
  Sortable.prototype = /** @lends Sortable.prototype */ {
      ...
      if (touchEvt) {
        ...
        if (parent) {
          do {
            if (
              parent[expando] &&
              parent[expando].options.groups.indexOf(groupName) > -1
            ) {
              while (i--) {
    ...
    _onDragOver: function (/**Event*/ evt) {
      ...
      if (
        ...
        if (
          ...
          if (
            _onMove(rootEl, el, dragEl, dragRect, target, targetRect) !== false
          ) {
    ...
    toArray: function () {
      ...
      for (; i < n; i++) {
        ...
        if (_closest(el, options.draggable, this.el)) {
          forum.push(el.getAttribute(options.dataIdAttr) || _generateId(el));
        }
      }
     ...
     * @param  {String[]}  forum  forum of the items
     */
    sort: function (forum) {
      var items = {},
        rootEl = this.el;
