...
!(function (e) {
  ...
  (t = ".fileinput"),
    ...
    (p = {
      ...
      init: function (e) {
        var t = e.initialPreview,
          i = e.id;
        t.length > 0 && !re(t) && (t = t.split(e.initialPreviewDelimiter)),
          (p.data[i] = {
            content: t,
            ...
            parseTemplate: function (t, i, a, n, r, l, o) {
              ...
              return e._generatePreviewTemplate(
                t,
                i,
                a,
                n,
            ...
            footer: e
              ...
              .replace(/\{progress}/g, e._renderThumbProgress()),
      ...
      count: function (e, t) {
        return p.data[e] && p.data[e].content
          ? t
            ? p.data[e].content.length
            : p.fetch(e).length
          : 0;
      },
      get: function (t, i, a) {
        ...
        return (
          ...
          m
            ? (f && f.frameClass && (v += " " + f.frameClass),
              h
                ? ((l = u.previewAsData
                    ? le("type", f, u.previewFileType || "generic")
                    : "generic"),
                  (o = le("caption", f)),
                  (s = p.footer(t, i, a, (f && f.size) || null)),
                  (d = le("filetype", f, l)),
                  (n = u.parseTemplate(l, m, o, d, g, s, c, null)))
                : (n = u.template
                    .replace(/\{previewId}/g, g)
                    .replace(/\{frameClass}/g, v)
                    .replace(/\{fileindex}/g, c)
                    .replace(/\{content}/g, u.content[i])
                    .replace(/\{template}/g, le("type", f, u.previewFileType))
                    .replace(
                      /\{footer}/g,
                      p.footer(t, i, a, (f && f.size) || null)
                    )),
              u.tags.length && u.tags[i] && (n = de(n, u.tags[i])),
              ne(f) ||
                ne(f.frameAttr) ||
                ((r = e(document.createElement("div")).html(n)),
                r.find(".file-preview-initial").attr(f.frameAttr),
                (n = r.html()),
                r.remove()),
              n)
            : ""
      ...
      add: function (t, i, a, n, r) {
        var l,
          o = e.extend(!0, {}, p.data[t]);
        return (
          re(i) || (i = i.split(o.delimiter)),
          r
            ? ((l = o.content.push(i) - 1), (o.config[l] = a), (o.tags[l] = n))
            : ((l = i.length - 1),
              (o.content = i),
              (o.config = a),
              (o.tags = n)),
      ...
      set: function (t, i, a, n, r) {
        var l,
          o,
          s = e.extend(!0, {}, p.data[t]);
        if (
          i &&
          i.length &&
          (re(i) || (i = i.split(s.delimiter)),
      ...
      unset: function (e, t) {
        ...
        if (i) {
          ...
          (p.data[e].content[t] = null),
            (p.data[e].config[t] = null),
            (p.data[e].tags[t] = null);
        }
      },
      out: function (e) {
        var t,
      ...
      footer: function (e, t, i, a) {
        ...
        if (
          ((i = void 0 === i ? !0 : i),
          0 === n.config.length || ne(n.config[t]))
        )
          return "";
        var r = n.config[t],
          l = le("caption", r),
    ...
    (_ = '<i class="glyphicon glyphicon-file kv-caption-icon"></i>'),
    (x =
    ...
    (ae = {
      ...
      text: function (e, t) {
        return (
          o(e, "text.*") ||
          o(t, /\.(xml|javascript)$/i) ||
          o(t, /\.(txt|md|csv|nfo|ini|json|php|js|css)$/i)
        );
      },
      video: function (e, t) {
        return (
          o(e, "video.*") &&
          (o(e, /(ogg|mp4|mp?g|webm|3gp)$/i) ||
            o(t, /\.(og?|mp4|webm|mp?g|3gp)$/i))
        );
      },
      audio: function (e, t) {
        return (
          o(e, "audio.*") &&
          (o(t, /(ogg|mp3|mp?g|wav)$/i) || o(t, /\.(og?|mp3|mp?g|wav)$/i))
        );
      },
      flash: function (e, t) {
    ...
    (ge.prototype = {
      ...
      _init: function (t) {
        ...
        e.each(t, function (e, t) {
          ...
          ne(a.allowedPreviewTypes) && (a.allowedPreviewTypes = ee),
          (a.fileInputCleared = !1),
          (a.fileBatchCompleted = !0),
          a.isPreviewable || (a.showPreview = !1),
          (a.uploadFileAttr = ne(n.attr("name"))
            ? "file_data"
            : n.attr("name")),
          (a.reader = null),
          (a.formdata = {}),
          ...
          (a.progressCompleteTemplate = i.replace(
            "{class}",
            a.progressCompleteClass
          )),
          (a.progressErrorTemplate = i.replace(
            "{class}",
            a.progressErrorClass
          )),
          (a.dropZoneEnabled = m() && a.dropZoneEnabled),
          (a.isDisabled =
            a.$element.attr("disabled") || a.$element.attr("readonly")),
          (a.isUploadable = g() && !ne(a.uploadUrl)),
          (a.isClickable =
            a.browseOnZoneClick &&
            a.showPreview &&
            ((a.isUploadable && a.dropZoneEnabled) ||
              !ne(a.defaultPreviewContent))),
          (a.slug =
            "function" == typeof t.slugCallback
              ? t.slugCallback
              : a._slugDefault),
          (a.mainTemplate = a.showCaption
            ? a._getLayoutTemplate("main1")
            : a._getLayoutTemplate("main2")),
          (a.captionTemplate = a._getLayoutTemplate("caption")),
          (a.previewGenericTemplate = a._getPreviewTemplate("generic")),
          a.resizeImage &&
            (a.maxImageWidth || a.maxImageHeight) &&
            ((a.imageCanvas = document.createElement("canvas")),
            (a.imageCanvasContext = a.imageCanvas.getContext("2d"))),
          ne(a.$element.attr("id")) && a.$element.attr("id", oe()),
          void 0 === a.$container
            ? (a.$container = a._createContainer())
            : a._refreshContainer(),
          ...
          (a.$captionContainer = te(
            t,
            "elCaptionContainer",
            a.$container.find(".file-caption")
          )),
          (a.$caption = te(
            t,
            "elCaptionText",
            a.$container.find(".file-caption-name")
          )),
          (a.$previewContainer = te(
            t,
            "elPreviewContainer",
            a.$container.find(".file-preview")
          )),
          (a.$preview = te(
            t,
            "elPreviewImage",
            a.$container.find(".file-preview-thumbnails")
          )),
          (a.$previewStatus = te(
            t,
            "elPreviewStatus",
            a.$container.find(".file-preview-status")
          )),
          (a.$errorContainer = te(
            t,
            "elErrorContainer",
            a.$previewContainer.find(".kv-fileinput-error")
          )),
          ne(a.msgErrorClass) || v(a.$errorContainer, a.msgErrorClass),
          a.$errorContainer.hide(),
          (a.fileActionSettings = e.extend(!0, X, t.fileActionSettings)),
          (a.previewInitId = "preview-" + oe()),
      ...
      _validate: function () {
        var e,
          t = this;
        return "file" === t.$element.attr("type")
          ? !0
          : ((e =
      ...
      _errorsExist: function () {
        var t,
          i = this;
        return i.$errorContainer.find("li").length
          ? !0
          : ((t = e(document.createElement("div")).html(
              i.$errorContainer.html()
            )),
            t.find("span.kv-error-close").remove(),
            t.find("ul").remove(),
      ...
      _addError: function (e) {
        ...
        e &&
          ...
          c(i.find(".kv-error-close"), "click", function () {
            i.fadeOut("slow");
          }));
      },
      ...
      _showFolderError: function (e) {
        var t,
          ...
          a = i.$errorContainer;
        e &&
          ((t = i.msgFoldersNotAllowed.replace(/\{n}/g, e)),
          i._addError(t),
          v(i.$container, "has-error"),
          a.fadeIn(800),
      ...
      _parseFileType: function (e) {
        ...
        for (n = 0; n < ee.length; n += 1)
          if (
            ((a = ee[n]),
            (t = le(a, r.fileTypeSettings, ae[a])),
            (i = t(e.type, e.name) ? a : ""),
            !ne(i))
          )
            return i;
        ...
        return (
          i &&
            ...
            r.previewFileIconSettings &&
              r.previewFileIconSettings[n] &&
              (l = r.previewFileIconSettings[n]),
            r.previewFileExtSettings &&
              e.each(r.previewFileExtSettings, function (e, t) {
                return r.previewFileIconSettings[e] && t(n)
                  ? void (l = r.previewFileIconSettings[e])
                  : void (a = !0);
              })),
          t.indexOf("{previewFileIcon}") > -1
            ? t
                .replace(/\{previewFileIconClass}/g, r.previewFileIconClass)
                .replace(/\{previewFileIcon}/g, l)
            : t
        );
      },
      _raise: function (t, i) {
      ...
      _listen: function () {
        var t = this,
          ...
          a = i.closest("form"),
          n = t.$container;
        c(i, "change", e.proxy(t._change, t)),
          t.showBrowse && c(t.$btnFile, "click", e.proxy(t._browse, t)),
          c(a, "reset", e.proxy(t.reset, t)),
          c(
            n.find(".fileinput-remove:not([disabled])"),
            "click",
            e.proxy(t.clear, t)
          ),
          c(n.find(".fileinput-cancel"), "click", e.proxy(t.cancel, t)),
          t._initDragDrop(),
          t.isUploadable || c(a, "submit", e.proxy(t._submitForm, t)),
          c(
            t.$container.find(".fileinput-upload"),
            "click",
            e.proxy(t._uploadClick, t)
          ),
      ...
      _initClickable: function () {
        ...
        i.isClickable &&
          ((t = i.isUploadable
            ? i.$dropZone
            : i.$preview.find(".file-default-preview")),
          v(t, "clickable"),
          t.attr("tabindex", -1),
          c(t, "click", function (a) {
            var n = e(a.target);
            (n.parents(".file-preview-thumbnails").length &&
              !n.parents(".file-default-preview").length) ||
              (i.$element.trigger("click"), t.blur());
          }));
      },
      _initDragDrop: function () {
        ...
        t.isUploadable &&
          t.dropZoneEnabled &&
          t.showPreview &&
          (c(i, "dragenter dragover", e.proxy(t._zoneDragEnter, t)),
          c(i, "dragleave", e.proxy(t._zoneDragLeave, t)),
          c(i, "drop", e.proxy(t._zoneDrop, t)),
          c(e(document), "dragenter dragover drop", t._zoneDragDropInit));
      },
      ...
      _zoneDrop: function (e) {
        ...
        e.preventDefault(),
          t.isDisabled ||
            ne(e.originalEvent.dataTransfer.files) ||
      ...
      _submitForm: function () {
        ...
        return i &&
          e.minFileCount > 0 &&
          e._getFileCount(i.length) < e.minFileCount
          ? (e._noFilesError({}), !1)
          : !e._abort({});
      },
      _clearPreview: function () {
        var e = this,
          t = e.showUploadedThumbs
            ? e.$preview.find(".file-preview-frame:not(.file-preview-success)")
            : e.$preview.find(".file-preview-frame");
        t.remove(),
        ...
        window.Sortable &&
          ...
          (i = {
            ...
            onSort: function (t) {
              var i = t.oldIndex,
                n = t.newIndex;
              (a.initialPreview = me(a.initialPreview, i, n)),
                (a.initialPreviewConfig = me(a.initialPreviewConfig, i, n)),
                p.init(a),
                a._raise("filesorted", {
      ...
      _initPreview: function (e) {
        ...
        return p.count(i.id)
          ? ((t = p.out(i.id)),
            ...
            i.$preview.html(t.content),
            i._setCaption(a),
            i._initSortable(),
            void (ne(t.content) || i.$container.removeClass("file-input-new")))
      ...
      _getZoomButton: function (e) {
        ...
        return (
          ("fullscreen" !== e && "bforumless" !== e && "toggleheader" !== e) ||
            (r +=
      ...
      _getModalContent: function () {
        ...
        return e
          ...
          .replace(/\{bforumless}/g, e._getZoomButton("bforumless"))
          ...
          t._raise("filezoom" + e, a(n)),
            "shown" === e &&
              ...
              i.hasClass("file-zoom-fullscreen") &&
                ...
                ue()
                  ? r.addClass("active").attr("aria-pressed", "true")
      ...
      _initZoomButtons: function () {
        ...
        l &&
          ...
          t.length && t.attr("id") === n && o.attr("disabled", !0),
      ...
      _setZoomContent: function (t, i) {
        ...
        (n = t.data("template") || "generic"),
          ...
          i
            ...
            : o.html(r),
          (d = u.previewZoomSettings[n]),
          d &&
            ((s = o.find(".kv-preview-data")),
            v(s, "file-zoom-detail"),
            e.each(d, function (e, t) {
              s.css(e, t),
                ((s.attr("width") && "width" === e) ||
                  (s.attr("height") && "height" === e)) &&
                  s.removeAttr(e);
            })),
          m.data("previewId", f),
          c(g, "click", function () {
            ...
            var e,
              ...
              n = function (e) {
                var i = u.$modal.find(".kv-zoom-body"),
                  a = u.zoomModalHeight;
                m.hasClass("file-zoom-fullscreen") &&
          ...
          c(m, "keydown", function (e) {
            ...
            37 !== t || g.attr("disabled") || u._zoomSlideShow("prev", f),
      ...
      _initPreviewActions: function () {
        var t = this,
          ...
          a = function () {
            ...
            0 !== t.$preview.find(".kv-file-remove").length ||
              e ||
              (t.reset(), (t.initialCaption = ""));
          };
        t._initZoomButton(),
          t.$preview.find(".kv-file-remove").each(function () {
            ...
            if (!ne(r) && void 0 !== l) {
              var o,
                ...
                m = p.data[t.id],
                g = f.data("fileindex");
              (g = parseInt(g.replace("init_", ""))),
                (d = ne(m.config) && ne(m.config[g]) ? null : m.config[g]),
                (u = ne(d) || ne(d.extra) ? i : d.extra),
                  ...
                  {},
                  {
                    ...
                    beforeSend: function (e) {
                      (t.ajaxAborted = !1),
                        ...
                        t.ajaxAborted
                          ? e.abort()
                          : (v(f, "file-uploading"), v(n, "disabled"));
                    },
                    success: function (e, i, r) {
                      var o, d;
                      return ne(e) || ne(e.error)
                        ? (p.unset(t.id, g),
                          (o = p.count(t.id)),
      ...
      _getThumbs: function (e) {
        return (
          (e = e || ""),
          this.$preview.find(
            ".file-preview-frame:not(.file-preview-initial)" + e
          )
        );
      },
            ...
            e.upload.addEventListener(
              ...
              function (e) {
                ...
                e.lengthComputable && (n = Math.ceil((r / l) * 100)),
                  t
                    ? a._setAsyncUploadStatus(t, n, i)
                    : a._setProgress(Math.ceil(n));
              },
              !1
            ),
          e
      ...
      _initUploadSuccess: function (t, i, a) {
        ...
        f.showPreview &&
          ...
          (c = t.initialPreviewThumbTags || []),
          (n = !(void 0 !== t.append && !t.append)),
          s.length > 0 && !re(s) && (s = s.split(f.initialPreviewDelimiter)),
          (f.overwriteInitial = !1),
          f.initialPreview.concat(s),
          f.initialPreviewThumbTags.concat(c),
          f.initialPreviewConfig.concat(d),
          void 0 !== i
            ? a
              ? ((u = i.attr("data-fileindex")),
                (f.uploadCache.content[u] = s[0]),
                (f.uploadCache.config[u] = d[0]),
                (f.uploadCache.tags[u] = c[0]),
                (f.uploadCache.append = n))
              : ((l = p.add(f.id, s, d[0], c[0], n)),
                (r = p.get(f.id, l, !1)),
                (o = e(r).hide()),
        ...
        t.showPreview &&
          t._getThumbs(".file-preview-success").each(function () {
            ...
            a.removeAttr("disabled"),
              c(a, "click", function () {
                var e = t._raise("filesuccessremove", [
                  i.attr("id"),
                  i.data("fileindex"),
                ]);
                ce(i),
                  e !== !1 &&
                    i.fadeOut("slow", function () {
                      i.remove(),
                        t.$preview.find(".file-preview-frame").length ||
                          t.reset();
                    });
              });
          });
      ...
      _uploadSingle: function (t, i, a) {
        ...
        (g.formdata = w),
          ...
          0 === h ||
            ...
            g._abort(C) ||
            ((m = function (e, t) {
              g.updateStack(e, void 0),
                g.uploadLog.push(t),
                g._checkAsyncComplete() && (g.fileBatchCompleted = !0);
            }),
            (l = function () {
              var e = g.uploadCache;
              g.fileBatchCompleted &&
                setTimeout(function () {
                  g.showPreview &&
                    (p.set(g.id, e.content, e.config, e.tags, e.append),
                    g.hasInitData &&
                      (g._initPreview(), g._initPreviewActions())),
                    g.unlock(),
                    g._clearFileInput(),
                    g._raise("filebatchuploadcomplete", [
                      g.filestack,
                      g._getExtraData(),
                    ]),
                    (g.uploadCount = 0),
            ...
            (d = function (i) {
              (n = g._getOutData(i)),
                (g.fileBatchCompleted = !1),
                g.showPreview &&
                  (r.hasClass("file-preview-success") ||
                    (g._setThumbStatus(r, "Loading"), v(r, "file-uploading")),
                  o.attr("disabled", !0),
                  s.attr("disabled", !0)),
                a || g.lock(),
                g._raise("filepreupload", [n, b, t]),
                e.extend(!0, C, n),
                g._abort(C) && (i.abort(), g._setProgressCancelled());
            }),
            (c = function (i, l, s) {
              (n = g._getOutData(s, i)),
                e.extend(!0, C, n),
                setTimeout(function () {
                  ne(i) || ne(i.error)
                    ? (g.showPreview &&
                        (g._setThumbStatus(r, "Success"),
                        o.hide(),
                        g._initUploadSuccess(i, r, a)),
                      g._raise("fileuploaded", [n, b, t]),
                      a ? m(t, b) : g.updateStack(t, void 0))
                    : (g._showUploadError(i.error, C),
                      g._setPreviewError(r, t),
                      a && m(t, b));
                }, 100);
            }),
            (u = function () {
              setTimeout(function () {
                g.showPreview &&
                  ...
                  a ? l() : (g.unlock(!1), g._clearFileInput()),
                  g._initSuccessThumbs();
              }, 100);
            }),
            (f = function (n, l, o) {
              ...
              setTimeout(function () {
                a && m(t, b),
                  (g.uploadStatus[b] = 100),
                  g._setPreviewError(r, t),
                  e.extend(!0, C, g._getOutData(n)),
                  g._showUploadError(s, C);
              }, 100);
            }),
            w.append(g.uploadFileAttr, i[t], g.filenames[t]),
            w.append("file_id", t),
            g._ajaxSubmit(d, c, u, f, b, t));
      },
              ...
              l.showPreview &&
                l._getThumbs().each(function () {
                  ...
                  t.hasClass("file-preview-success") ||
                    (l._setThumbStatus(t, "Loading"), v(t, "file-uploading")),
                    i.attr("disabled", !0),
                    a.attr("disabled", !0);
                }),
        ...
        (n.formdata = new FormData()),
          n._abort(r) ||
            ...
            (t = function (e, t, i) {
              ...
              ne(e) || ne(e.error)
                ? (n._raise("filebatchuploadsuccess", [a]),
                  n._clearFileInput(),
                  n._initUploadSuccess(e))
                : n._showUploadError(e.error, a, "filebatchuploaderror");
            }),
            (i = function () {
              n._setProgress(100),
                n.unlock(),
      ...
      _initFileActions: function () {
        ...
        t.showPreview &&
          ...
          t.$preview.find(".kv-file-remove").each(function () {
            ...
            c(l, "click", function () {
              return (
                (r = t._raise("filepreremove", [s, d])),
                r !== !1 && t._validateMinCount()
                  ? ((i = o.hasClass("file-preview-error")),
                    ce(o),
                    void o.fadeOut("slow", function () {
                      t.updateStack(d, void 0),
                        t._clearObjects(o),
                        o.remove(),
                        s &&
                          i &&
                          t.$errorContainer
                            .find('li[data-file-id="' + s + '"]')
          ...
          t.$preview.find(".kv-file-upload").each(function () {
            ...
            c(i, "click", function () {
              ...
              e.hasClass("file-preview-error") ||
                t._uploadSingle(a, t.filestack, !1);
            });
          }));
      },
        ...
        return (
          "function" == typeof l
            ...
            : ((i = Math.floor(Math.log(t) / Math.log(1024))),
              ...
              (n = 1 * (t / Math.pow(1024, i)).toFixed(2) + " " + a[i])),
          ...
          g.length ||
            ...
            m || h
              ? ((l = o._generatePreviewTemplate(
                ...
                g.append("\n" + l),
                o._validateImage(t, n, c, i.type))
              : o._previewDefault(i, n),
            o._initSortable();
        }
      },
        ...
        (a.loadedImages = []),
          ...
          (i = function (e) {
            ...
            var _,
              ...
              Z = ne(L) ? "" : L.join(", ");
            if (
              (ne(L) || (D = new RegExp("\\.(" + L.join("|") + ")$", "i")),
              (P = P.toFixed(2)),
              a.maxFileSize > 0 && P > a.maxFileSize)
            )
              return (
                (T = a.msgSizeTooLarge
                  .replace("{name}", I)
            ...
            return 0 !== A ||
              ...
              ? a.showPreview
                ? !w && P > h
                  ...
                  : (r.length && void 0 !== FileReader
                      ? (c.html(
                          p.replace("{index}", e + 1).replace("{files}", m)
                        ),
                        d.addClass("file-thumb-loading"),
                        ...
                        (_ = le("text", g, ae.text)),
                        (C = le("image", g, ae.image)),
                        _(S.type, I)
                          ? s.readAsText(S, a.textEncoding)
                          : C(S.type, I)
                          ? s.readAsDataURL(S)
                          : s.readAsArrayBuffer(S))
                      : (a._previewDefault(S, $),
                        setTimeout(function () {
              ...
              : ((T = a.msgInvalidFileExtension
                  .replace("{name}", I)
                  .replace("{extensions}", Z)),
                void (a.isError = b(T, S, $, e)));
          }),
          i(0),
      ...
      _updateFileDetails: function (e) {
        ...
        t.isError
          ...
          p.count(t.id) && t._initPreviewActions();
      },
      _setThumbStatus: function (e, t) {
        ...
        if (i.showPreview) {
          ...
          e.removeClass(
            ...
            "Success" === t &&
              (e.find(".file-drag-handle").remove(), l.css("margin-left", 0)),
            l.html(o[a]),
            l.attr("title", o[n]),
            e.addClass(r);
        }
        ...
        var a = this,
          ...
          r =
            100 > n
              ? a.progressTemplate
              : i
              ? a.progressErrorTemplate
              : a.progressCompleteTemplate;
        (t = t || a.$progress),
          ne(r) ||
            (t.html(r.replace(/\{percent}/g, n)),
      ...
      _setFileDropZoneTitle: function () {
        var e,
          ...
          a = t.dropZoneTitle;
        t.isClickable &&
          ((e = ne(t.$element.attr("multiple")) ? t.fileSingle : t.filePlural),
          ...
          t.isUploadable &&
            ...
            (0 === i.find(".file-preview-frame").length &&
              ne(t.defaultPreviewContent) &&
              i.prepend(
                '<div class="' + t.dropZoneTitleClass + '">' + a + "</div>"
              ),
            t.$container.removeClass("file-input-new"),
            v(t.$container, "file-input-ajax-new"));
      },
          ...
          u.length &&
            c(u, "load", function () {
              (r = p.width()),
                ...
                s.resizeImage ||
                  (s._checkDimensions(e, "Large", u, p, i, "Width", n),
                  s._checkDimensions(e, "Large", u, p, i, "Height", n)),
      ...
      _validateAllImages: function () {
        var e,
          ...
          s = {};
        if (
          o.loadedImages.length === o.totalImagesCount &&
          (o._raise("fileimagesloaded"), o.resizeImage)
        ) {
          for (
            l = o.isUploadable ? o._showUploadError : o._showError, e = 0;
            e < o.loadedImages.length;
            e++
          )
            (t = o.loadedImages[e]),
              (i = t.img),
              ...
              (r = t.ind),
              (s = { id: n, index: r }),
              o._getResizedImage(i[0], t.typ, n, r) ||
                (l(o.msgImageResizeError, s, "fileimageresizeerror"),
                o._setPreviewError(a, r));
      ...
      _initCaption: function () {
        var e = this,
          t = e.initialCaption || "";
        return e.overwriteInitial || ne(t)
          ? (e.$caption.html(""), !1)
          : (e._setCaption(t), !0);
      },
            ...
            (a = e("<div>" + o.msgValidationError + "</div>").text()),
              ...
              (l = r
                ? 1 === r && s[0]
                  ? o._getFileNames()[0]
                  : o._getMsgSelected(r)
                : o._getMsgSelected(o.msgNo)),
              (n =
                '<span class="' +
                o.msgValidationErrorClass +
                '">' +
                o.msgValidationErrorIcon +
                (ne(t) ? l : t) +
                "</span>");
          else {
            if (ne(t)) return;
      ...
      _renderMain: function () {
        var e = this,
          ...
          n = e.isDisabled
            ...
            : e.captionClass,
          r = e.captionTemplate.replace(
            /\{class}/g,
            n + " kv-fileinput-caption"
          );
        ...
        return (
          ...
          (n = r.isUploadable
            ? p
                .replace(
                  /\{actions}/g,
                  r._renderFileActions(o, d, c, s, !1, !1, !1)
                )
                .replace(/\{caption}/g, e)
                .replace(/\{size}/g, t)
                .replace(/\{width}/g, i)
            ...
            : p
                .replace(
                  /\{actions}/g,
                  r._renderFileActions(!1, !1, c, s, !1, !1, !1)
                )
                .replace(/\{caption}/g, e)
                .replace(/\{size}/g, t)
                .replace(/\{width}/g, i)
      ...
      _browse: function (e) {
        ...
        t._raise("filebrowse"),
          (e && e.isDefaultPrevented()) ||
            (t.isError && !t.isUploadable && t.clear(),
            t.$captionContainer.focus());
      },
      _change: function (t) {
        var i = this,
          a = i.$element;
        if (!i.isUploadable && ne(a.val()) && i.fileInputCleared)
          return void (i.fileInputCleared = !1);
        ...
        if (
          ...
          !u || h
            ...
            : !u ||
              0 !== g ||
              (p.count(i.id) && !i.overwriteInitial) ||
      ...
      _resetFileStack: function () {
        ...
        t._getThumbs().each(function () {
          ...
          -1 !== l &&
            (void 0 !== o
              ? ((a[i] = o),
                (n[i] = t._getFileName(o)),
                r.attr({ id: t.previewInitId + "-" + i, "data-fileindex": i }),
                i++)
              : r.attr({ id: "uploaded-" + oe(), "data-fileindex": "-1" }));
        }),
          (t.filestack = a),
          (t.filenames = n);
      },
      ...
      updateStack: function (e, t) {
        var i = this;
        return (
          (i.filestack[e] = t), (i.filenames[e] = i._getFileName(t)), i.$element
        );
      },
      addToStack: function (e) {
        var t = this;
        return (
          t.filestack.push(e), t.filenames.push(t._getFileName(e)), t.$element
        );
      },
      ...
      lock: function () {
        ...
        return (
          e._resetErrors(),
          e.disable(),
          e.showRemove && v(e.$container.find(".fileinput-remove"), "hide"),
          e.showCancel &&
      ...
      unlock: function (e) {
        ...
        return (
          void 0 === e && (e = !0),
          t.enable(),
          t.showCancel && v(t.$container.find(".fileinput-cancel"), "hide"),
          t.showRemove &&
        ...
        return (
          ...
          i._hasInitialPreview()
            ...
            : (i._getThumbs().each(function () {
              ...
              v(i.$container, "file-input-new"),
              i._validateDefaultPreview()),
          0 === i.$container.find(".file-preview-frame").length &&
            (i._initCaption() ||
              i.$captionContainer.find(".kv-caption-icon").hide()),
          i._hideFileIcon(),
      ...
      upload: function () {
        ...
        if (n.minFileCount > 0 && n._getFileCount(r) < n.minFileCount)
          return void n._noFilesError(l);
        if (n.isUploadable && !n.isDisabled && (0 !== r || o)) {
          ...
          if (((a = n.filestack.length), (n.hasInitData = !1), !n.uploadAsync))
            return n._uploadBatch(), n.$element;
          for (
            i = n._getOutData(),
              n._raise("filebatchpreupload", [i]),
      ...
      refresh: function (t) {
        var i = this,
          a = i.$element;
        return (
          (t = t ? e.extend(!0, {}, i.options, t) : i.options),
          i.destroy(),
          a.fileinput(t),
        ...
        switch (
          ...
          this.each(function () {
            ...
            l ||
              ...
              "en" === p ||
                ne(e.fn.fileinputLocales[p]) ||
                (d = e.fn.fileinputLocales[p] || {}),
              (n = e.extend(
                !0,
                {},
