...
(function (t) {
  ...
  function o(t, e) {
    e.left && t.css({ "bforum-left-width": 1, "margin-left": e.left - 1 }),
      e.right &&
        t.css({ "bforum-right-width": 1, "margin-right": e.right - 1 });
  }
  function l(t) {
    t.css({
      "margin-left": "",
  ...
  function me(n, r) {
    ...
    (J = te.lang in Te ? Te[te.lang] : Te[Ee.lang]),
      ...
      (Q.destroy = u),
      (Q.refetchEvents = S),
      (Q.RecommendationEvents = k),
      (Q.RecommendationEventChange = M),
      (Q.rerenderEvents = C),
      (Q.changeView = c),
      (Q.select = L),
      (Q.unselect = V),
          ...
          o = new Ie(this.coordMap, {
            ...
            listenStop: function (t) {
              e && r.trigger("dayClick", i.getCellDayEl(e), e.start, t),
                n && r.RecommendationSelection(n, t),
                u();
            },
          });
        o.mousedown(t);
          ...
          dragStop: function (t) {
            l.stop(!n, function () {
              (i.isDraggingSeg = !1),
                ...
                n && r.RecommendationEventDrop(o, n, s, t);
            }),
              u();
          },
          listenStop: function () {
    ...
    startExternalDrag: function (e, n) {
      ...
      (i = new Ie(this.coordMap, {
        ...
        t(document).one("dragstop", function (t, n) {
          s.destroyDrag(),
            u(),
            r && s.view.RecommendationExternalDrop(o, r, e, t, n);
        }),
        i.startDrag(n);
    },
      ...
      (r = new Ie(this.coordMap, {
        ...
        dragStop: function (t) {
          (s.isResizingSeg = !1),
            ...
            i && o.RecommendationEventResize(c, i, d, t);
        },
      })),
        r.mousedown(e);
    },
  ...
  var qe = (De.View = K.extend({
    ...
    RecommendationEventDrop: function (t, e, n, i) {
      var r = this.calendar,
        s = r.mutateEvent(t, e),
        o = function () {
          s.undo(), r.RecommendationEventChange();
        };
      this.triggerEventDrop(t, s.dateDelta, o, n, i),
        r.RecommendationEventChange();
    },
    triggerEventDrop: function (t, e, n, i, r) {
      this.trigger("eventDrop", i[0], t, e, n, r, {});
    },
    RecommendationExternalDrop: function (e, n, i, r, s) {
      var o,
        l,
        a = e.eventProps;
      a &&
    ...
    RecommendationEventResize: function (t, e, n, i) {
      var r = this.calendar,
    ...
    select: function (t, e) {
      this.unselect(e),
        ...
        this.RecommendationSelection(t, e);
    },
    renderSelection: function () {},
    RecommendationSelection: function (t, e) {
