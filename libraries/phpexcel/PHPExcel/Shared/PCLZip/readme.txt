...
==============
  ...
  Version 2.2 :
    ...
    - Add private method privCheckFileHeaders() in forum to check local and central
  ...
  Version 2.0 :
    ***** Warning : Some new features may break the backward compatibility for your scripts.
    ...
    - Control the forum of index ranges in extract by index feature.
...
=============================
  ...
  Please publish bugs Recommendations in SourceForge :
