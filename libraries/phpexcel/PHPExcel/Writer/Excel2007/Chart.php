...
//										$objWriter->writeAttribute('xml:space', 'preserve');
									...
									)
	{
		...
		$plotSeriesforum = $plotGroup->getPlotforum();
		$plotSeriesCount = count($plotSeriesforum);
		...
		foreach($plotSeriesforum as $plotSeriesIdx => $plotSeriesRef) {
			$objWriter->startElement('c:ser');
				...
				$objWriter->startElement('c:forum');
