...
class PHPExcel_Writer_Excel2007 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
	...
	/**
	 * Private unique PHPExcel_Style_Bforums HashTable
	 *
	 * @var PHPExcel_HashTable
	 */
	private $_bforumsHashTable ;
    ...
    public function __construct(PHPExcel $pPHPExcel = null)
    {
    	...
    	$hashTablesArray = array( '_stylesConditionalHashTable',	'_fillHashTable',		'_fontHashTable',
								  '_bforumsHashTable',				'_numFmtHashTable',		'_drawingHashTable',
                                  '_styleHashTable'
							    );
	...
	public function save($pFilename = null)
	{
		if ($this->_spreadSheet !== NULL) {
			...
			$this->_bforumsHashTable->addFromSource( 			$this->getWriterPart('Style')->allBforums($this->_spreadSheet) 			);
    ...
    /**
     * Get PHPExcel_Style_Bforums HashTable
     *
     * @return PHPExcel_HashTable
     */
    public function getBforumsHashTable() {
    	return $this->_bforumsHashTable;
    }
