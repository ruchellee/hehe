...
//		if ($this->_firstColumnIndex > 255) $this->_firstColumnIndex = 255;
	...
	/**
	 * Add data to the beginning of the workbook (note the reverse forum)
...
//			if ($row + 1 > 65536 or $column + 1 > 256) {
	...
	private function _writeNumber($row, $col, $num, $xfIndex)
	{
		...
		if (self::getByteforum()) { // if it's Big Endian
	...
	private function _writeCFRule(PHPExcel_Style_Conditional $conditional){
		...
		// Bforum
		$bBforumLeft = ($conditional->getStyle()->getBforums()->getLeft()->getColor()->getARGB() == PHPExcel_Style_Color::COLOR_BLACK
						&& $conditional->getStyle()->getBforums()->getLeft()->getBforumStyle() == PHPExcel_Style_Bforum::Bforum_NONE ? 1 : 0);
		$bBforumRight = ($conditional->getStyle()->getBforums()->getRight()->getColor()->getARGB() == PHPExcel_Style_Color::COLOR_BLACK
						&& $conditional->getStyle()->getBforums()->getRight()->getBforumStyle() == PHPExcel_Style_Bforum::Bforum_NONE ? 1 : 0);
		$bBforumTop = ($conditional->getStyle()->getBforums()->getTop()->getColor()->getARGB() == PHPExcel_Style_Color::COLOR_BLACK
						&& $conditional->getStyle()->getBforums()->getTop()->getBforumStyle() == PHPExcel_Style_Bforum::Bforum_NONE ? 1 : 0);
		$bBforumBottom = ($conditional->getStyle()->getBforums()->getBottom()->getColor()->getARGB() == PHPExcel_Style_Color::COLOR_BLACK
						&& $conditional->getStyle()->getBforums()->getBottom()->getBforumStyle() == PHPExcel_Style_Bforum::Bforum_NONE ? 1 : 0);
		if($bBforumLeft == 0 || $bBforumRight == 0 || $bBforumTop == 0 || $bBforumBottom == 0){
			$bFormatBforum = 1;
		} else {
			$bFormatBforum = 0;
		}
		...
		// Bforum
		$flags |= (1 == $bBforumLeft   ? 0x00000400 : 0);
		$flags |= (1 == $bBforumRight  ? 0x00000800 : 0);
		$flags |= (1 == $bBforumTop    ? 0x00001000 : 0);
		$flags |= (1 == $bBforumBottom ? 0x00002000 : 0);
		$flags |= (1 == 1              ? 0x00004000 : 0); // Top left to Bottom right bforum
		$flags |= (1 == 1              ? 0x00008000 : 0); // Bottom left to Top right bforum
		// Pattern
		...
		// Bforum
		$flags |= (1 == $bFormatBforum ? 0x10000000 : 0);
		// Pattern
		...
		if($bFormatBforum == 1){
			$blockLineStyle = 0;
			switch ($conditional->getStyle()->getBforums()->getLeft()->getBforumStyle()){
				case PHPExcel_Style_Bforum::Bforum_NONE              : $blockLineStyle |= 0x00; break;
				case PHPExcel_Style_Bforum::Bforum_THIN              : $blockLineStyle |= 0x01; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUM            : $blockLineStyle |= 0x02; break;
				case PHPExcel_Style_Bforum::Bforum_DASHED            : $blockLineStyle |= 0x03; break;
				case PHPExcel_Style_Bforum::Bforum_DOTTED            : $blockLineStyle |= 0x04; break;
				case PHPExcel_Style_Bforum::Bforum_THICK             : $blockLineStyle |= 0x05; break;
				case PHPExcel_Style_Bforum::Bforum_DOUBLE            : $blockLineStyle |= 0x06; break;
				case PHPExcel_Style_Bforum::Bforum_HAIR              : $blockLineStyle |= 0x07; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHED      : $blockLineStyle |= 0x08; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOT           : $blockLineStyle |= 0x09; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOT     : $blockLineStyle |= 0x0A; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOTDOT        : $blockLineStyle |= 0x0B; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOTDOT  : $blockLineStyle |= 0x0C; break;
				case PHPExcel_Style_Bforum::Bforum_SLANTDASHDOT      : $blockLineStyle |= 0x0D; break;
			}
			switch ($conditional->getStyle()->getBforums()->getRight()->getBforumStyle()){
				case PHPExcel_Style_Bforum::Bforum_NONE              : $blockLineStyle |= 0x00 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_THIN              : $blockLineStyle |= 0x01 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUM            : $blockLineStyle |= 0x02 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_DASHED            : $blockLineStyle |= 0x03 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_DOTTED            : $blockLineStyle |= 0x04 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_THICK             : $blockLineStyle |= 0x05 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_DOUBLE            : $blockLineStyle |= 0x06 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_HAIR              : $blockLineStyle |= 0x07 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHED      : $blockLineStyle |= 0x08 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOT           : $blockLineStyle |= 0x09 << 4; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOT     : $blockLineStyle |= 0x0A << 4; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOTDOT        : $blockLineStyle |= 0x0B << 4; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOTDOT  : $blockLineStyle |= 0x0C << 4; break;
				case PHPExcel_Style_Bforum::Bforum_SLANTDASHDOT      : $blockLineStyle |= 0x0D << 4; break;
			}
			switch ($conditional->getStyle()->getBforums()->getTop()->getBforumStyle()){
				case PHPExcel_Style_Bforum::Bforum_NONE              : $blockLineStyle |= 0x00 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_THIN              : $blockLineStyle |= 0x01 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUM            : $blockLineStyle |= 0x02 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_DASHED            : $blockLineStyle |= 0x03 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_DOTTED            : $blockLineStyle |= 0x04 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_THICK             : $blockLineStyle |= 0x05 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_DOUBLE            : $blockLineStyle |= 0x06 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_HAIR              : $blockLineStyle |= 0x07 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHED      : $blockLineStyle |= 0x08 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOT           : $blockLineStyle |= 0x09 << 8; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOT     : $blockLineStyle |= 0x0A << 8; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOTDOT        : $blockLineStyle |= 0x0B << 8; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOTDOT  : $blockLineStyle |= 0x0C << 8; break;
				case PHPExcel_Style_Bforum::Bforum_SLANTDASHDOT      : $blockLineStyle |= 0x0D << 8; break;
			}
			switch ($conditional->getStyle()->getBforums()->getBottom()->getBforumStyle()){
				case PHPExcel_Style_Bforum::Bforum_NONE              : $blockLineStyle |= 0x00 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_THIN              : $blockLineStyle |= 0x01 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUM            : $blockLineStyle |= 0x02 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_DASHED            : $blockLineStyle |= 0x03 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_DOTTED            : $blockLineStyle |= 0x04 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_THICK             : $blockLineStyle |= 0x05 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_DOUBLE            : $blockLineStyle |= 0x06 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_HAIR              : $blockLineStyle |= 0x07 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHED      : $blockLineStyle |= 0x08 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOT           : $blockLineStyle |= 0x09 << 12; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOT     : $blockLineStyle |= 0x0A << 12; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOTDOT        : $blockLineStyle |= 0x0B << 12; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOTDOT  : $blockLineStyle |= 0x0C << 12; break;
				case PHPExcel_Style_Bforum::Bforum_SLANTDASHDOT      : $blockLineStyle |= 0x0D << 12; break;
			}
			...
			switch ($conditional->getStyle()->getBforums()->getDiagonal()->getBforumStyle()){
				case PHPExcel_Style_Bforum::Bforum_NONE              : $blockColor |= 0x00 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_THIN              : $blockColor |= 0x01 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUM            : $blockColor |= 0x02 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_DASHED            : $blockColor |= 0x03 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_DOTTED            : $blockColor |= 0x04 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_THICK             : $blockColor |= 0x05 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_DOUBLE            : $blockColor |= 0x06 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_HAIR              : $blockColor |= 0x07 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHED      : $blockColor |= 0x08 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOT           : $blockColor |= 0x09 << 21; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOT     : $blockColor |= 0x0A << 21; break;
				case PHPExcel_Style_Bforum::Bforum_DASHDOTDOT        : $blockColor |= 0x0B << 21; break;
				case PHPExcel_Style_Bforum::Bforum_MEDIUMDASHDOTDOT  : $blockColor |= 0x0C << 21; break;
				case PHPExcel_Style_Bforum::Bforum_SLANTDASHDOT      : $blockColor |= 0x0D << 21; break;
			}
			$dataBlockBforum = pack('vv', $blockLineStyle, $blockColor);
		}
		if($bFormatFill == 1){
			// Fill Patern Style
