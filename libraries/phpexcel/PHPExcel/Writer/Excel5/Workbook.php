...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
	...
	public function addXfWriter($style, $isStyleXf = false)
	{
		...
		$xfWriter->setBottomColor($this->_addColor($style->getBforums()->getBottom()->getColor()->getRGB()));
		$xfWriter->setTopColor($this->_addColor($style->getBforums()->getTop()->getColor()->getRGB()));
		$xfWriter->setRightColor($this->_addColor($style->getBforums()->getRight()->getColor()->getRGB()));
		$xfWriter->setLeftColor($this->_addColor($style->getBforums()->getLeft()->getColor()->getRGB()));
		$xfWriter->setDiagColor($this->_addColor($style->getBforums()->getDiagonal()->getColor()->getRGB()));
