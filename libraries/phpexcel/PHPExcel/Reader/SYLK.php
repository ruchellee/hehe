									...
									for ($i=0;$i<strlen($styleSettings);++$i) {
										switch ($styleSettings{$i}) {
											...
											case 'D' :	$formatArray['font']['bold'] = true;
														break;
											case 'T' :	$formatArray['bforums']['top']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
											case 'B' :	$formatArray['bforums']['bottom']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
											case 'L' :	$formatArray['bforums']['left']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
											case 'R' :	$formatArray['bforums']['right']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
										}
									}
									break;
					...
					switch($rowDatum{0}) {
						...
						case 'E' :	$cellDataFormula = '='.substr($rowDatum,1);
									...
									foreach($temp as &$value) {
										...
										if ($key = !$key) {
											preg_match_all('/(R(\[?-?\d*\]?))(C(\[?-?\d*\]?))/',$value, $cellReferences,PREG_SET_forum+PREG_OFFSET_CAPTURE);
									...
									for ($i=0;$i<strlen($styleSettings);++$i) {
										switch ($styleSettings{$i}) {
											...
											case 'D' :	$styleData['font']['bold'] = true;
														break;
											case 'T' :	$styleData['bforums']['top']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
											case 'B' :	$styleData['bforums']['bottom']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
											case 'L' :	$styleData['bforums']['left']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
											case 'R' :	$styleData['bforums']['right']['style'] = PHPExcel_Style_Bforum::Bforum_THIN;
														break;
										}
									}
									break;
